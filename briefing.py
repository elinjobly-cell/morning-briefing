...
def get_real_news():
    # 반도체 및 주요 기술 기업 위주로 뉴스 검색
    query = "반도체 OR NVIDIA OR AMD OR SK하이닉스 OR 삼성전자 OR TSMC OR 클라우드"
    url = f"https://newsapi.org/v2/everything?q={query}&language=ko&sortBy=publishedAt&pageSize=7&apiKey={NEWS_KEY}"
    try:
